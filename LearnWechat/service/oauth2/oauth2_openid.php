...
/*
本文件位置
$redirect_url= "http://pemakocn.sinaapp.com/service/oauth2/oauth2_openid.php";

URL
https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0188a6062fc51b93&redirect_uri=http%3A%2F%2Fpemakocn.sinaapp.com%2Fservice%2Foauth2%2Foauth2_openid.php&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect"
*/
					...
					<LI>
						<P>
							...
							<div class="fieldcontain">
								...
								<input name="subscribe_time" id="subscribe_time" value="<?php echo date('Y-m-d H:i:s', $userinfo["subscribe_time"]);?>" type="text" >
							</div>
						</p>
					</LI>
				</UL>
